                ...
                <FormProvider {...methods}>
                    <form>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={6}>
                                <FormDatepicker name="dateBirth" label="Дата рождения" value="" margin="dense" fullWidth required />
                                <FormInput name="phone" label="Телефон" value="" type='number' margin="dense" fullWidth/>
                            </Grid>

                            <Grid item xs={6}>
                                <FormInput name="adrReg" label="Адрес регистрации" value="" margin="dense" minRows={3} maxRows={6} multiline fullWidth />
                            </Grid>
                            <Grid item xs={6}>
                                <FormInput name="adrPhys" label="Адрес пребывания" value="" margin="dense" minRows={3} maxRows={6} multiline fullWidth />
                            </Grid>

                            <Grid item xs={6}>
                                <FormInput name="jobPlace" label="Место работы" value="" margin="dense" minRows={3} maxRows={6} multiline fullWidth />
                            </Grid>
                            <Grid item xs={6}>
